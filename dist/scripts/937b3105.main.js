...
define("backbone/backbone", ["underscore/underscore","jquery"], (function (global) {
    return function () {
        var ret, fn;
...
define('text!tpl/Shell.html',[],function () { return '<div class="navbar navbar-fixed-top navbar-inverse">\n\t<div class="navbar-inner">\n\t\t\t<div class="container">\n\t\t\t\t<div class="nav-collapse collapse">\n\t\t\t\t\t<ul class="nav" id="nav-menu">\n\t\t\t\t\t\t<li class="home-menu active"><a href="#">Home</a></li>\n\t\t\t\t\t\t<li class="register-menu"><a href="#register">Register</a></li>\n\t\t\t\t\t\t<li class="music-menu"><a href="#">Music</a>\n\t\t\t\t\t\t\t<div id="player">\n\t\t\t\t\t\t\t\t<object width="250" height="250">\n\t\t\t\t\t\t\t\t\t<param name="movie" value="http://grooveshark.com/widget.swf">\n\t\t\t\t\t\t\t\t\t<param name="wmode" value="window">\n\t\t\t\t\t\t\t\t\t<param name="allowScriptAccess" value="always">\n\t\t\t\t\t\t\t\t\t<param name="flashvars" value="hostname=cowbell.grooveshark.com&amp;playlistID=89930127&amp;bbg=B4D5DA&amp;bth=B4D5DA&amp;pfg=B4D5DA&amp;lfg=B4D5DA&amp;bt=813B45&amp;pbg=813B45&amp;pfgh=813B45&amp;si=813B45&amp;lbg=813B45&amp;lfgh=813B45&amp;sb=813B45&amp;bfg=B1BABF&amp;pbgh=B1BABF&amp;lbgh=B1BABF&amp;sbh=B1BABF&amp;p=0"><embed src="http://grooveshark.com/widget.swf" type="application/x-shockwave-flash" width="250" height="250" flashvars="hostname=cowbell.grooveshark.com&amp;playlistID=89930127&amp;bbg=B4D5DA&amp;bth=B4D5DA&amp;pfg=B4D5DA&amp;lfg=B4D5DA&amp;bt=813B45&amp;pbg=813B45&amp;pfgh=813B45&amp;si=813B45&amp;lbg=813B45&amp;lfgh=813B45&amp;sb=813B45&amp;bfg=B1BABF&amp;pbgh=B1BABF&amp;lbgh=B1BABF&amp;sbh=B1BABF&amp;p=0" allowscriptaccess="always" wmode="window">\n\t\t\t\t\t\t\t\t</object>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\t<div class="row-fluid" id="content">\n\t\t\n\t</div>\n\t<div class="status-bar">\n\t      <div class="span6">\n\t          <div class="alert alert-success" style="display: none">\n\t              <b>Success!</b> Rate saved successfully\n\t          </div>\n\t      </div>\n\t    </div>\n\t<footer class="navbar navbar-fixed-bottom navbar-inverse">\n\t\t<div class="navbar-inner">\n\t\t\t<div class="container">\n\t\t\t\t<p class="">&copy; Game Center 2013. <span>Powered by <a href="http://www.thehangar.cr" title="The Hangar Interactive"><img src="images/hangar_logo_white.png" alt="" /></a></span></p>\n\t\t\t</div>\n\t\t</div>\n\t</footer>\n</div>';});

define('source/views/Shell',['require','jquery','underscore/underscore','backbone/backbone','text!tpl/Shell.html'],function (require) {
...
define('text!tpl/Home.html',[],function () { return '<div id="login" class="contentFrame">\n\t<h2>Game Center</h2>\n\t<form action="/">\n\t\t<div class="control-group">\n\t\t\t<div class="controls">\n\t\t\t\t<input type="text" id="username" name="username" placeholder="Username">\n\t\t\t\t<span class="help-inline"></span>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="control-group">\n\t\t\t<div class="controls">\n\t\t\t\t<input type="password" id="password" name="password" placeholder="Password">\n\t\t\t\t<span class="help-inline"></span>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="control-group">\n\t\t\t<div class="controls">\n\t\t\t\t<button type="submit" class="btn send-login">Login</button>\n\t\t\t</div>\n\t\t</div>\n\t</form>\n\t<p>First time? Register first <a href="#register" class="">Go!</a></p>\n</div>';});

define('source/views/Home',['require','jquery','underscore/underscore','backbone/backbone','text!tpl/Home.html'],function (require) {
...
define('text!tpl/Register.html',[],function () { return '<div id="registration" class="contentFrame">\n  <h2>Out Of Space</h2>\n  <h3>REGISTRATION</h3>\n  <form action="/register">\n    <div class="control-group">\n      <div class="controls">\n        <input type="text" id="username" name="username" placeholder="Username">\n        <span class="help-inline"></span>\n      </div>\n    </div>\n    <div class="control-group">\n      <div class="controls">\n        <input type="password" name="password" id="password" placeholder="Password">\n        <span class="help-inline"></span>\n      </div>\n    </div>\n    <div class="control-group">\n      <div class="controls">\n        <input type="password" id="verify" placeholder="Verify">\n        <span class="help-inline"></span>\n      </div>\n    </div>\n    <div class="control-group">\n      <div class="controls">\n        <button type="submit" class="disabled btn btn-inverse save">Create soul</button>\n        <a href="#" class="btn btn-inverse delete">Cancel</a>\n      </div>\n    </div>\n  </form>\n</div>';});
...
define("source/utils", function(){});

define('source/views/Register',['require','jquery','underscore/underscore','backbone/backbone','text!tpl/Register.html','source/utils'],function (require) {
...
define('source/router',['require','jquery','backbone/backbone','source/views/Shell','source/views/Home','source/views/Register','source/views/Register','source/utils'],function (require) {
